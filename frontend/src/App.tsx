...
import AIProjectArtifactGeneratorWithTabs from './pages/AIProjectArtifactGeneratorWithTabs'
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 lg:ml-64 p-6 lg:p-8 pt-16 lg:pt-6">
        <Routes>
          ...
          />
          <Route 
            path="/dynamic-timeline/:projectId" 
            element={
              <ProtectedRoute>
                <DynamicTimelinePage />
              </ProtectedRoute>
          ...
          <Route 
            ...
            element={
              <ProtectedRoute>
                <Navigate to="/dynamic-timeline" replace />
              </ProtectedRoute>
            } 
          />
          <Route 
