          ...
          <div className="relative">
            ...
            {showEmojiPicker === comment.id && (
              <>
                ...
                />
                {/* Enhanced Single Row Emoji Picker */}
                <div className={`absolute ${pickerPosition === 'left' ? 'right-0' : 'left-0'} top-12 bg-white border border-gray-200 rounded-xl shadow-2xl z-[99999] p-4 min-w-[400px] max-w-[440px] animate-in fade-in zoom-in duration-200`}
                     style={{ 
