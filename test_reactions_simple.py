...
def test_reactions():
    ...
    login_response = requests.post(
        "https://ai-artifact-gen-1.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://ai-artifact-gen-1.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
