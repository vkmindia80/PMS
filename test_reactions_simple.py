...
def test_reactions():
    ...
    login_response = requests.post(
        "https://cost-breakdown-1.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://cost-breakdown-1.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
