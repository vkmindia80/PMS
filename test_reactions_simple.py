...
def test_reactions():
    ...
    login_response = requests.post(
        "https://api-gateway-fix-7.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://api-gateway-fix-7.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
