...
def test_reactions():
    ...
    login_response = requests.post(
        "https://github-connect-17.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://github-connect-17.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
