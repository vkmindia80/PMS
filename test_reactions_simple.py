...
def test_reactions():
    ...
    login_response = requests.post(
        "https://test-data-forge-1.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://test-data-forge-1.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
