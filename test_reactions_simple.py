...
def test_reactions():
    ...
    login_response = requests.post(
        "https://data-gen-wizard.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://data-gen-wizard.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
