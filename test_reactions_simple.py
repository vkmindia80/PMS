...
def test_reactions():
    ...
    login_response = requests.post(
        "https://s3-project-docs.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://s3-project-docs.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
