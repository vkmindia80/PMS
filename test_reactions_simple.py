...
def test_reactions():
    ...
    login_response = requests.post(
        "https://timeline-enhance.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://timeline-enhance.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
