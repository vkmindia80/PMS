...
def test_reactions():
    ...
    login_response = requests.post(
        "https://fix-reaction-ui.preview.emergentagent.com/api/auth/login",
    ...
    reaction_response = requests.post(
        f"https://fix-reaction-ui.preview.emergentagent.com/api/comments/{comment_id}/reactions?emoji=👍",
        headers=headers
    )
