...
class ComprehensiveDemoDataGenerator:
    ...
    async def generate_report(self):
        ...
        try:
            ...
            print(f"   📊 Resource Allocations: {report['summary']['resource_allocations_created']}")
            print(f"   ⏱️ Time Entries: {report['summary']['time_entries_created']}")
            print(f"   📈 Project Metrics: {report['summary']['project_metrics_created']}")
