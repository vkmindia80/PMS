...
- Frontend was served over HTTPS: `https://s3-project-docs.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://s3-project-docs.preview.emergentagent.com` fallbacks
