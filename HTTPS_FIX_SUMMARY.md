...
- Frontend was served over HTTPS: `https://task-display-repair.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://task-display-repair.preview.emergentagent.com` fallbacks
