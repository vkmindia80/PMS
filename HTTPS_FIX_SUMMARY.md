...
- Frontend was served over HTTPS: `https://sync-activity-count.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://sync-activity-count.preview.emergentagent.com` fallbacks
