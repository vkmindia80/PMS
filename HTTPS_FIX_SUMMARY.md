...
- Frontend was served over HTTPS: `https://code-linker-6.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://code-linker-6.preview.emergentagent.com` fallbacks
