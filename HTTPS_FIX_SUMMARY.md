...
- Frontend was served over HTTPS: `https://api-gateway-fix-7.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://api-gateway-fix-7.preview.emergentagent.com` fallbacks
