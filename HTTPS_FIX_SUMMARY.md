...
- Frontend was served over HTTPS: `https://code-connect-10.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://code-connect-10.preview.emergentagent.com` fallbacks
