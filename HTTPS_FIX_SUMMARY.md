...
- Frontend was served over HTTPS: `https://project-details-fix.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://project-details-fix.preview.emergentagent.com` fallbacks
