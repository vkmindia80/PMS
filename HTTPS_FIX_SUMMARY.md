...
- Frontend was served over HTTPS: `https://test-data-forge-1.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://test-data-forge-1.preview.emergentagent.com` fallbacks
