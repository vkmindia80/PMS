...
- Frontend was served over HTTPS: `https://zero-downtime-gen.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://zero-downtime-gen.preview.emergentagent.com` fallbacks
