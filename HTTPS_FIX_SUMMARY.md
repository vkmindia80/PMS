...
- Frontend was served over HTTPS: `https://timeline-overhaul.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://timeline-overhaul.preview.emergentagent.com` fallbacks
