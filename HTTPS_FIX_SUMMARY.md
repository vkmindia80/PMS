...
- Frontend was served over HTTPS: `https://project-tasks-view.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://project-tasks-view.preview.emergentagent.com` fallbacks
